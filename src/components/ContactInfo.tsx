        ...
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <a 
              ...
              className="text-sm md:text-base block mt-3 text-creinum-orange/80 group-hover:text-creinum-orange transition-colors duration-300 relative inline-block group-hover:underline"
            >
